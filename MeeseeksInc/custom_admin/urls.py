...
urlpatterns = [
    ...
    url(r'^edit/loan/(?P<pk>[\w\-\ ]+)/$', views.AdminIndexView.edit_loan, name='edit_loan'),
    url(r'^convert/loan/(?P<pk>[\w\-\ ]+)/$', views.AdminIndexView.convert_loan, name='convert_loan'),
    url(r'^checkIn/loan/(?P<pk>[\w\-\ ]+)/$', views.AdminIndexView.check_in_loan, name='check_in_loan'),
    
    url(r'^disburse/item$', views.AdminIndexView.post_new_disburse, name='AdminIndexView.post_new_disburse'),
    url(r'^disburse/item/(?P<pk>[\w\-\ ]+)/$', views.post_new_disburse_specific, name='post_specific_disburse'),
    
    url(r'^request/accept/addcomment/(?P<pk>[\w\-\ ]+)/$', views.AdminIndexView.add_comment_to_request_accept, name='add_comment_to_request_accept'),
    url(r'^request/deny/addcomment/(?P<pk>[\w\-\ ]+)/$', views.AdminIndexView.add_comment_to_request_deny, name='add_comment_to_request_deny'),
    ...
    url(r'^edit/item/module/(?P<pk>[\w\-\ ]+)/$', views.AdminIndexView.edit_item_module, name='edit_item_module'),
