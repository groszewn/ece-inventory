...
urlpatterns = [
 ...
 #   url(r'^loan/detail/checkIn/loan/(?P<pk>[\w\-\ ]+)/$', custom_admin.views.check_in_loan, name='check_in_loan'), 
    url(r'^loan/detail/edit/loan/(?P<pk>[\w\-\ ]+)/$', custom_admin.views.LoanView.edit_loan, name='edit_loan'), 
...
#     url(r'^api/requests/multiple_create/(?P<item_list>[\w\-\ (\,)?]+)/$', inventory.api.APIMultipleRequests.as_view()),
    url(r'^api/requests/multiple_create/$', inventory.api.APIMultipleRequests.as_view()),
    ...
    url(r'^api/disbursements/direct/with/assets/(?P<pk>[\w\-\ ]+)/$', inventory.api.APIDirectDisbursementWithAssets.as_view()),
    ...
    url(r'^api/upload/asset/$', inventory.api.AssetUpload.as_view(), name='asset_upload'),    
