...
urlpatterns = [
 ...
 #   url(r'^loan/detail/checkIn/loan/(?P<pk>[\w\-\ ]+)/$', custom_admin.views.check_in_loan, name='check_in_loan'), 
    ...
    url(r'^api/asset/custom/field/$', inventory.api.APIAssetCustomField.as_view()),
    url(r'^api/custom/field/modify/(?P<pk>[\w\-\ ]+)/$', inventory.api.APICustomFieldModify.as_view()),
    url(r'^api/asset/custom/field/modify/(?P<pk>[\w\-\ ]+)/$', inventory.api.APIAssetCustomFieldModify.as_view()),
